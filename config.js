...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐍ᴇᴇʟɪ 𝐏ᴇɴɴɪ 🧛🏻‍♀️',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐍ᴇᴇʟɪ 𝐏ᴇɴɴɪ 🧛🏻‍♀️;𝐊᪵ıʀᴀ⃗ᴎ̻ 𝐒͢ᴇ⃗ʀ̻×᷼×;919539060020;https://i.imgur.com/AfQXEdM.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐍ᴇᴇʟɪ 𝐏ᴇɴɴɪ 🧛🏻‍♀️;𝐊᪵ıʀᴀ⃗ᴎ̻ 𝐒͢ᴇ⃗ʀ̻×᷼×;https://i.imgur.com/AfQXEdM.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐍ᴇᴇʟɪ 𝐏ᴇɴɴɪ 🧛🏻‍♀️;𝐊᪵ıʀᴀ⃗ᴎ̻ 𝐒͢ᴇ⃗ʀ̻×᷼×' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '919539060020,0',
       DEBUG: DEBUG
};
